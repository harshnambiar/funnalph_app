...
const web3_1 = __webpack_require__(21);
const Funnel_ral_json_1 = __importDefault(__webpack_require__(468));
const contracts_1 = __webpack_require__(939);
const types_1 = __webpack_require__(793);
const web3_2 = __webpack_require__(21);
...
const web3_1 = __webpack_require__(21);
const structs_ral_json_1 = __importDefault(__webpack_require__(196));
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"version":"v3.8.4","name":"Funnel","bytecode":"","codeHash":"a1e75987dc38b522c5a0a1e854116ea837d59dd86ad58705e8bbbae5add9bce8","fieldsSig":{"names":["count","raffle","reward","lastrun","leadingentry","leadingamount"],"types":["U256","U256","U256","U256","U256","U256"],"isMutable":[true,true,true,true,true,true]},"eventsSig":[{"name":"NewEntry","fieldNames":["by","to","agent","value"],"fieldTypes":["Address","Address","Address","U256"]},{"name":"NewRaffle","fieldNames":["by","winner","amount","timestamp"],"fieldTypes":["Address","Address","U256","U256"]},{"name":"NewReward","fieldNames":["by","winner","amount","timestamp"],"fieldTypes":["Address","Address","U256","U256"]}],"functions":[{"name":"createEntry","paramNames":["amt","to","ag"],"paramTypes":["U256","Address","Address"],"paramIsMutable":[false,false,false],"returnTypes":[]},{"name":"raffleDist","paramNames":[],"paramTypes":[],"paramIsMutable":[],"returnTypes":[]},{"name":"rewardDist","paramNames":[],"paramTypes":[],"paramIsMutable":[],"returnTypes":[]}],"constants":[],"enums":[{"name":"ErrorCodes","fields":[{"name":"SelfPay","value":{"type":"U256","value":"0"}},{"name":"AgentPay","value":{"type":"U256","value":"1"}},{"name":"DataMalfunction","value":{"type":"U256","value":"2"}},{"name":"LackOfBal","value":{"type":"U256","value":"3"}},{"name":"NoneEligible","value":{"type":"U256","value":"4"}},{"name":"RaffleLow","value":{"type":"U256","value":"5"}},{"name":"RewardLow","value":{"type":"U256","value":"6"}},{"name":"OngoingCycle","value":{"type":"U256","value":"7"}}]}],"mapsSig":{"names":["entries"],"types":["Map[U256,Entries]"]}}');
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('[{"name":"Entries","fieldNames":["payer","payee","agent","amount","ts"],"fieldTypes":["Address","Address","Address","U256","U256"],"isMutable":[true,true,true,true,true]}]');
...
// EXTERNAL MODULE: ./src/artifacts/ts/Funnel.js
var Funnel = __webpack_require__(574);
...
async function create_entry(){
    ...
    const nodeProvider = new alephium_web3_min.NodeProvider(nodeUrl)
    alephium_web3_min.web3.setCurrentNodeProvider(nodeProvider)

    const funnelAddress = 'zPiJiMa3jZVKMjBtTK7eUFUvWHH8AsXEeBQxgAtoa5yU'
    const fun = Funnel.Funnel.at(funnelAddress)
    console.log(wallet);
    try {
